...
class Max3DSParser extends ParserBase {
    ...
    private function parseVertexList():Void {
        ...
        _cur_obj.verts = new Float32Array( count * 3 );
    ...
    private function parseFaceList():Void {
        ...
        count = _byteData.readUnsignedShort();
        _cur_obj.indices = new Int16Array( count * 3 );
        ...
        _cur_obj.smoothingGroups = new Int16Array( count );		
    }
    ...
    private function parseUVList():Void {
        ...
        count = _byteData.readUnsignedShort();
        _cur_obj.uvs = new Float32Array( count * 2 );
    ...
    private function parseFaceMaterialList():Void {
        ...
        var count:Int;
        var i:Int;
        var faces:Int16Array;

        mat = readNulTermString();
        count = _byteData.readUnsignedShort();

        faces = new Int16Array( count );
        i = 0;
        while (i < count) {
    ...
    private function constructObject(obj:ObjectVO, pivot:Vector3D = null):ObjectContainer3D {
        if (obj.type == Asset3DType.MESH) {
            ...
            obj.verts = new Float32Array( vertices.length * 3 );
            for (i in 0...vertices.length) {
                obj.verts[i * 3] = vertices[i].x;
                obj.verts[i * 3 + 1] = vertices[i].y;
                obj.verts[i * 3 + 2] = vertices[i].z;
            }
            obj.indices = new Int16Array( faces.length * 3 );
            ...
            if (obj.uvs != null) {
                ...
                obj.uvs = new Float32Array( vertices.length * 2 );
                for (i in 0...vertices.length) {
    ...
    private function applySmoothGroups(vertices:Array<VertexVO>, faces:Array<FaceVO>):Void {
        ...
        var vGroups:Array<Int16Array> = new Array<Int16Array>();
        for (i in 0...numVerts) {
            vGroups.push(new Int16Array());
        }
        var groups:Int16Array;
        var group:UInt;
        var face:FaceVO;
        for (i in 0...numFaces) {
            face = faces[i];
        ...
        // clone vertices
        var vClones:Array<Int16Array> = new Array<Int16Array>();
        var clones:Int16Array;
        for (i in 0...numVerts) {
            if ((len = vGroups[i].length) < 1)
                continue;
            clones = new Int16Array( len );
			vClones[i] = clones;
            clones[0] = i;
...
class ObjectVO {
    ...
    public var verts:Float32Array;
    public var indices:Int16Array;
    public var uvs:Float32Array;
    public var materialFaces:StringMap<Int16Array>;
    public var materials:Array<String>;
    public var smoothingGroups:Int16Array;
